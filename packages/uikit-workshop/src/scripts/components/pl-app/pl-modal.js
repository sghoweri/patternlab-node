        ...
        <AnimateHeight
          ...
          height={
            drawerOpened && !isViewallPage
              ? drawerHeight > 20 ? drawerHeight : 'auto'
              : 0
          }
          className="pl-c-modal__wrapper"
        >
          <div className={classes}>
            <div class="pl-c-modal__toolbar">
              <div class="pl-c-modal__resizer" onMouseDown={this.onMouseDown} />
              <button
                class="pl-c-modal__close-btn"
